...
// 단축키 설정 (1400-1449 예약). 각 단축키마다 Ctrl/Shift/Alt/Win 체크박스 + 키 콤보박스.
pub const HOTKEY_TOGGLE_WINDOW_CTRL: u16 = 1400;
pub const HOTKEY_TOGGLE_WINDOW_SHIFT: u16 = 1401;
pub const HOTKEY_TOGGLE_WINDOW_ALT: u16 = 1402;
pub const HOTKEY_TOGGLE_WINDOW_WIN: u16 = 1403;
pub const HOTKEY_TOGGLE_WINDOW_KEY: u16 = 1404;

pub const HOTKEY_TEXT_SIZE_UP_CTRL: u16 = 1410;
pub const HOTKEY_TEXT_SIZE_UP_SHIFT: u16 = 1411;
pub const HOTKEY_TEXT_SIZE_UP_ALT: u16 = 1412;
pub const HOTKEY_TEXT_SIZE_UP_WIN: u16 = 1413;
pub const HOTKEY_TEXT_SIZE_UP_KEY: u16 = 1414;

pub const HOTKEY_TEXT_SIZE_DOWN_CTRL: u16 = 1420;
pub const HOTKEY_TEXT_SIZE_DOWN_SHIFT: u16 = 1421;
pub const HOTKEY_TEXT_SIZE_DOWN_ALT: u16 = 1422;
pub const HOTKEY_TEXT_SIZE_DOWN_WIN: u16 = 1423;
pub const HOTKEY_TEXT_SIZE_DOWN_KEY: u16 = 1424;

pub const HOTKEY_CLIPBOARD_WATCH_CTRL: u16 = 1430;
pub const HOTKEY_CLIPBOARD_WATCH_SHIFT: u16 = 1431;
pub const HOTKEY_CLIPBOARD_WATCH_ALT: u16 = 1432;
pub const HOTKEY_CLIPBOARD_WATCH_WIN: u16 = 1433;
pub const HOTKEY_CLIPBOARD_WATCH_KEY: u16 = 1434;

/// 단축키 미리보기 라벨 (현재 조합을 "Ctrl+Shift+A" 형태로 표시)
pub const HOTKEY_TOGGLE_WINDOW_PREVIEW: u16 = 1440;
pub const HOTKEY_TEXT_SIZE_UP_PREVIEW: u16 = 1441;
pub const HOTKEY_TEXT_SIZE_DOWN_PREVIEW: u16 = 1442;
pub const HOTKEY_CLIPBOARD_WATCH_PREVIEW: u16 = 1443;
...
pub const TRANSLATION_STATIC_IDS: &[u16] = &[
    ...
    2236, 2237, 2238, 2240, 2241, 2242,
];
pub const HOTKEYS_STATIC_IDS: &[u16] = &[2300, 2301, 2302, 2303, 2304, 2305];
