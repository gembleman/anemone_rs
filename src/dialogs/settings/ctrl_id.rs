...
// 커스텀 API 설정 (1310-1319 예약)
pub const CUSTOM_URL_EDIT: u16 = 1310;
pub const CUSTOM_API_KEY_EDIT: u16 = 1311;
pub const CUSTOM_AUTH_HEADER_EDIT: u16 = 1312;
pub const CUSTOM_AUTH_SCHEME_EDIT: u16 = 1313;
pub const CUSTOM_REQUEST_TEMPLATE_EDIT: u16 = 1314;
pub const CUSTOM_RESPONSE_PATH_EDIT: u16 = 1315;
pub const CUSTOM_HEADERS_EDIT: u16 = 1316;
...
pub const CUSTOM_STATIC_IDS: &[u16] = &[2240, 2241, 2242, 2243, 2244, 2245, 2246, 2247, 2248];
